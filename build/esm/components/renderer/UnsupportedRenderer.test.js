...
describe("component UnsupportedRenderer", () => {
    it("must display mime-type not supported", () => {
        const { getByText } = render(React.createElement(UnsupportedRenderer, { attachment: { type: "application/epub+zip", data: "", filename: "" } }));
...
//# sourceMappingURL=UnsupportedRenderer.test.js.map